...
const menu = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        image: "/src/assets/food/food-8.jpeg",
      },
      {
      ...
      },
      {
        ...
        image: "/src/assets/food/food-9.jpeg",
      },
      {
      ...
      },
      {
        ...
        image: "/src/assets/food/food-10.jpeg",
...

  {
    ...
    items: [
      ...
      {
        name: "Just Pancakes", description: "Single Stack (2) – Short Stack (4)",
        image: "/src/assets/food/food-11.jpeg",
      },
      {
        name: "Waffles (2)", description: "Plain or Fruit Waffles. Butter, powdered sugar, and syrup",
        image: "/src/assets/food/food-12.jpeg",
      },
      {
        name: "Crepes (3)",
        description: "Dulce de Leche, Cinnamon Sugar, Nutella and Banana, or Fresh Fruit",
        image: "/src/assets/food/food-13.jpeg",
    ...
    items: [
      {
        ...
        image: "/src/assets/food/food-14.jpeg",
      ...
      },
      {
        ...
        image: "/src/assets/food/food-15.jpeg",
...

  {
    ...
    items: [
      ...
      { name: "Veggie Omelet", description: "Cheddar cheese loaded with veggies." },
      {
        ...
        image: "/src/assets/food/food-16.jpeg",
...

  {
    section: "Salads",
    items: [
      { name: "Caesar Salad", description: "Romaine lettuce tossed with parmesan cheese, croutons, and creamy Caesar dressing." },
      {
        name: "Aroma Classic", description: "A mix of greens, avocado, onion, tomato, cheese, and tender grilled chicken.", image: "/src/assets/food/food-5.jpeg",
        image: "/src/assets/food/food-17.jpeg",
      },
      { name: "Chef salad", description: "Romaine lettuce, ham, turkey, tomato, hard-boiled egg, croutons, and cheddar cheese." },
...

  {
    ...
    items: [
      { name: "Aroma Classic Burger", image: "/src/assets/food/food-18.jpeg", },
      { name: "Bacon Cheeseburger", description: "Double patty, bacon, cheddar cheese, and burger sauce on a toasted bun." },
      { name: "Aromas Specialty Burger", description: "Double patty, bacon, avocado, tomato, lettuce, grilled onion, and jalapeno.", image: "/src/assets/food/food-19.jpeg", },
    ],
  },

  {
    ...
    items: [
      { name: "Philly Cheesesteak", image: "/src/assets/food/food-7.jpeg", },
      ...
      { name: "Chicken Ciabatta", description: "Grilled chicken, lettuce, tomato, onion, avocado, provolone cheese, chipotle mayo.", image: "/src/assets/food/food-6.jpeg", },
      { name: "Turkey Melt", description: "Toasted ciabatta bread with turkey, bacon, mayo, avocado, tomato, lettuce, and Provolone Cheese" },
    ],
  },

  {
    ...
    items: [
      {
        name: "Avocado toast", description: "Multigrain toast, avocado, tomato, spinach, alfalfa, seasoned with olive oil salt and pepper. One or Two Slices",
        image: "/src/assets/food/food-20.jpeg",
      },
      {
        name: "Acai Bowl", description: "Strawberries, bananas, blueberries, kiwi, coconut, granola, and honey.",
        image: "/src/assets/food/food-21.jpeg",
      },
...

  {
    section: "Beverages",
    items: [
      { name: "Fountain Drinks", description: "**Pepsi, Diet Pepsi, Dr Pepper, Diet Dr Pepper, Rt Beer, Ice Tea, 7-up, Lemonade, Mt Dew" },
